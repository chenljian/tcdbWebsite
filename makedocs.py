...
docs = [{
    ...
    "content": "<p>2017年1月14日，中国计算机学会(CCF)颁奖大会在北京隆重举行，数据库专委会再次蝉联优秀专委。根据《CCF专业委员会评估办法》，每年优秀专委会的数量不超过学会专委会总数的六分之一（本年度一共5个专委）；在这样竞争激烈的环境下，数据库专委能够再次评优，这是我们专委会老师们共同努力的结晶，是专委会一直以来秉承“团结同行、交流学术、发展学科、培养人才、服务国家”的办会宗旨，持续发扬"团结、执着、潇洒"的优秀文化，踏实努力工作的写照。</p>"
},
{
